...
async function forwardGET(res, url){
  try {
    ...
    console.error('Treasury debt forward error', err && err.message);
...
module.exports = async (req, res) => {
  try {
    ...
    console.log('treasury/debt incoming', { method: req.method, params });
    ...
    console.error('treasury/debt internal error', err && err.stack);
